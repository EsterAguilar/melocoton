        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="wachinleki"> Tarifas <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="wachinleki">Album</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="wachinleki">Tarifas</a>
                        <a class="dropdown-item" href="blog">Blog</a>
                        <!-- <div class="dropdown-divider"></div> -->
                        <a class="dropdown-item" href="wachinleky">Album</a>
                    </div>
                </li>
            </ul>
